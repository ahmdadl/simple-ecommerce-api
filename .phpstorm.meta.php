...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.E:\laragon\www\simple-ecommerce\api-simple-ecommerce\public\storage' => 'string',
...
'auth.guards.admin.driver','auth.guards.admin.provider','auth.guards.customer.driver','auth.guards.customer.provider','auth.guards.sanctum.driver',
...
'auth.providers.customers.driver','auth.providers.customers.model','auth.passwords.users.provider','auth.passwords.users.table','auth.passwords.users.expire',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.E:\\laragon\\www\\simple-ecommerce\\api-simple-ecommerce\\public\\storage','ide-helper.filename','ide-helper.models_filename',
...
'modules.stubs.enabled','modules.stubs.path','modules.stubs.files.routes/web','modules.stubs.files.routes/api','modules.stubs.files.composer',
...
'sanctum.csrf-cookie','api.addresses.index',
'api.addresses.store','api.addresses.update','api.addresses.destroy','api.brands.index','api.brands.show',
'api.cart.set-address','api.cart.create-address','api.cart.index','api.cart.add','api.cart.update-by-product',
'api.cart.update','api.cart.remove-by-product','api.cart.remove','api.cart.reset','api.categories.index',
'api.categories.show','api.products.index','api.products.show','api.uploads.show','uploads.show',
'api.auth.login','api.auth.register','api.auth.forget-password','api.auth.reset-password','api.profile.updateProfile',
'api.profile.changePassword','storage.local',);
...
'validation.url','validation.ulid','validation.uuid','validation.custom.attribute-name.rule-name','carts::t.quantity_must_be_at_least_one',
'carts::t.product_stock_is_not_enough','carts::t.product_not_found_in_cart','carts::t.payment_failed','users::t.invalid_credentials','users::t.email_not_found',
'users::t.invalid_token','users::t.token_expired','users::t.mail.welcome_subject','users::t.mail.greeting','users::t.mail.intro_line',
'users::t.mail.login_button','users::t.mail.outro_line','users::t.mail.signature','users::t.mail.guest_password_subject','users::t.mail.guest_password_greeting',
'users::t.mail.guest_password_line1','users::t.mail.guest_password_line2','users::t.mail.reset_password_button',);
